...
Begin VB.Form frmLab_tt 
   Caption         =   "Time Table By Lab"
   ClientHeight    =   5085
   ClientLeft      =   1110
   ClientTop       =   450
   ClientWidth     =   6675
   ...
   Begin MSAdodcLib.Adodc datPrimaryRS 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "select LAB,DAY,BATCH,START_TIME,END_TIME,INCHARGE from TIME_TABLE Order by LAB"
      Caption         =   " "
   ...
   Begin MSHierarchicalFlexGridLib.MSHFlexGrid MSHFlexGrid1 
      Bindings        =   "frmLab_tt.frx":0000
      DragIcon        =   "frmLab_tt.frx":001B
      Height          =   3840
      Left            =   60
      TabIndex        =   1
      Top             =   60
      ...
      MergeCells      =   4
      AllowUserResizing=   1
      FormatString    =   "LAB|DAY|BATCH|START_TIME|END_TIME|INCHARGE"
      _NumberOfBands  =   1
      _Band(0).Cols   =   6
