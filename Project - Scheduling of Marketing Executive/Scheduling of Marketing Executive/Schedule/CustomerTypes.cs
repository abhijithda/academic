...
namespace Schedule
{
	...
	public class CustomerTypes : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.TextBox txtMinVis;
		...
		private void InitializeComponent()
		{
			...
			this.txtMinVis = new System.Windows.Forms.TextBox();
			...
			this.groupBoxForType.Size = new System.Drawing.Size(280, 176);
			...
			this.txtNoVis.Location = new System.Drawing.Point(176, 64);
			this.txtNoVis.Name = "txtNoVis";
			this.txtNoVis.Size = new System.Drawing.Size(88, 23);
			this.txtNoVis.TabIndex = 26;
			this.txtNoVis.Text = "";
			// 
			// label3
			// 
			...
			this.label3.Text = "No. of Visits per Customer :";
			// 
			// lblType
			// 
			...
			this.btnNextType.Location = new System.Drawing.Point(184, 136);
			...
			this.groupBoxCusDetails.Location = new System.Drawing.Point(24, 296);
			...
			this.grpMaxVis.Size = new System.Drawing.Size(496, 80);
			...
			// txtMinVis
			// 
			this.txtMinVis.Font = new System.Drawing.Font("Verdana", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.txtMinVis.Location = new System.Drawing.Point(400, 48);
			this.txtMinVis.MaxLength = 2;
			this.txtMinVis.Name = "txtMinVis";
			this.txtMinVis.Size = new System.Drawing.Size(48, 23);
			this.txtMinVis.TabIndex = 22;
			this.txtMinVis.Text = "";
			// 
			// label7
			// 
			...
			this.label7.Size = new System.Drawing.Size(364, 27);
			this.label7.TabIndex = 21;
			this.label7.Text = "Enter the Minimum no. of visits allowed in a day :";
			// 
			// txtMaxVis
			// 
			...
			this.btnNextForm.Location = new System.Drawing.Point(576, 544);
			...
			this.txtNoCus.Location = new System.Drawing.Point(176, 104);
			this.txtNoCus.Name = "txtNoCus";
			this.txtNoCus.Size = new System.Drawing.Size(88, 23);
			this.txtNoCus.TabIndex = 28;
			this.txtNoCus.Text = "";
			// 
			// label2
			// 
		...
		private void btnNextForm_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				int tmp2 = int.Parse (txtMinVis.Text);
				if((tmp <= 0 || tmp2 <= 0) || (tmp < tmp2))
				{
					MessageBox.Show (this,"Enter Positive no.s greater than 0. \nand \n\tMin Visits less than Max Visits");
					return;
				}
				Form1.alloc.maxVisDay = tmp;
				Form1.alloc.tMax = tmp;
				Form1.alloc.minvisits = tmp2;
			}
			catch
			{
				MessageBox.Show (this,"Enter Positive no.s greater than 0");
