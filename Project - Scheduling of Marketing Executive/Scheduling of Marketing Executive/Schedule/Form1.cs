...
namespace Schedule
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		//		int [] CusInterval;
		public static bool dateflag = false;

		public static Allocate alloc;
		public static Company company ;
		public static CustomerTypes CusTypes ;
		public static Result result = new Result();
		public static Evaluating eval = new Evaluating();
		public static HiddenResults hidres = new HiddenResults ();
...
//			result = new Result();
		...
		private void InitializeComponent()
		{
			...
			this.linkLabelResult.LinkColor = System.Drawing.Color.White;
			...
			this.linkLabelCus.LinkColor = System.Drawing.Color.White;
			...
			this.linkLabelCom.LinkColor = System.Drawing.Color.GhostWhite;
